      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          if (Core.user.tags!.contains(TagUser.adminCategoryRead.number))
            IconButton(onPressed: () => create(dto: widget.dto, action: () => setState(() {})), icon: const Icon(Icons.add_box_outlined, size: 40)),
                                    ...
                                    Row(
                                      children: <Widget>[
                                        ...
                                        if (dto == null)
                                          TextButton(
                                            onPressed: () {
                                              dialogAlert(CategoryPage(dto: i).container(width: context.width));
                                            },
